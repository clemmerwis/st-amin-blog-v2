{{-- These need to go in their own partials eventually when they get used --}}
            ...
            <div class="col-lg-8">
                ...
                <div class="tab-elem">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">Ghost Stories</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab">Art Gallery</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tabs-4" role="tab">Health & Wellness</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tabs-4" role="tab">Magick</a>
                        </li>
                    </ul><!-- Tab panes -->
                        ...
                        <div class="tab-pane fade show active" id="tabs-1" role="tabpanel">
                            <div class="row">
                                <div class="un-slider owl-carousel">
                                    <div class="col-lg-12">
                                        <div class="un-big-item set-bg" data-setbg="./img/magazine/forest-sun-daylight1000.jpg">
                                            <div class="ub-text">
                                                <div class="label"><span>Stories of Mirrors</span></div>
                                                <h5><a href="#">Chapter 2: Subtitle</a></h5>
                                                <ul>
                                                    <li><i class="fa fa-pencil" aria-hidden="true"></i> <span>Erica Schmoll</span></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="un-item">
                                                    <div class="un_pic set-bg" data-setbg="img/news/news-3.jpg">
                                                        <div class="label"><span>User Submitted Stories</span></div>
                                                    </div>
                                                    <div class="un_text">
                                            ...
                                            <div class="col-md-4">
                                                <div class="un-item">
                                                    <div class="un_pic set-bg" data-setbg="img/news/news-4.jpg">
                                                        <div class="label"><span>Health & Wellness</span></div>
                                                    </div>
                                                    <div class="un_text">
                                                        <h6><a href="#">Downwell and space hulk: tactics are coming
                                                                to...</a></h6>
                                            ...
                                            <div class="col-md-4">
                                                <div class="un-item">
                                                    <div class="un_pic set-bg" data-setbg="img/news/news-2.jpg">
                                                        <div class="label"><span>Art Gallery</span></div>
                                                    </div>
                                                    <div class="un_text">
                                                        <h6><a href="#">Downwell and space hulk: tactics are coming
                                                                to...</a></h6>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="un-big-item set-bg" data-setbg="./img/magazine/compressed-nobull.jpg">
                                            <div class="ub-text">
                                                <div class="label"><span>Health & Wellness</span></div>
                                                <h5><a href="#">No Bullsh!t, buy No Bull!</a></h5>
                                                <ul>
                                                    <li><i class="fa fa-pencil" aria-hidden="true"></i> <span>Erica Schmoll</span></li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="un-item">
                                                    <div class="un_pic set-bg" data-setbg="img/news/news-3.jpg">
                                                        <div class="label"><span>Magick</span></div>
                                                    </div>
                                                    <div class="un_text">
                                                        <h6><a href="#">Downwell and space hulk: tactics are coming
                                                                to...</a></h6>
                ...
                <div class="sidebar-option">
                    <div class="social-media">
                        ...
                        <ul>
                            <li>
                                <div class="sm-icon">                        
                                    <a href="https://www.facebook.com/stories.of.mirrors/" target="_blank" aria-label="Share on Facebook" rel="noopener noreferrer">
