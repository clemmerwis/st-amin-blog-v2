            ...
            <div class="row d-flex justify-center pb-10">
                <div class="col-lg-6">                  
                    ...
                    <h3 class="smallh3 mb2rem">
                        <span>Writer</span>
                        <span>Technical Designer</span>
                        <span>Analytical Thinker</span>
                        <span>Energy & Spirit Organizer</span>
                    </h3>
                    
                    <p class="mb3rem">Welcome to a world where the mystical intersects with the rational, where tales of mirrors reflect the depth of the human spirit. I am Erica Denise Schmoll, a writer and technical designer driven by a passion to explore the unexplained mysteries of our existence. My journey is rooted in the belief that understanding our essential nature is not just a pursuit but a stylish art form.
                    </p>

                    <h3 class="specialh3">My Mission:</h3>
                    <p>My goal is to further the understanding of our essential nature with class and style. Through the power of design, digital communication, and data collection, I aim to spell out the magical energy that underlies our daily lives. I seek to provide patterns of vibration that explain our human experiences, helping us to remember who we are, rewrite history, and save our futures.</p>
                    ...
                    <p><strong>Email:</strong> <a class="about-page-link" href="mailto:erica@schmollthoughts.com">erica@schmollthoughts.com</a></p>
                
                    <h3 class="specialh3">Why I Wrote This Book:</h3>
                    <p>Because everyone deserves to know.</p>
